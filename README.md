...
Silently start Ollama for Windows — no popup window, no splash screen.
...
[@sunny15007](https://github.com/sunny15007)
...
The new Ollama desktop app (`ollama app.exe`) pops up its main window on startup, which is annoying. No solution could be found online.

## Solution

Through monitoring tools, I discovered that `ollama app.exe` supports two hidden startup parameters:
